...
<!-- Bruna. 2019. Refsplitr: Author name disambiguation, author georeferencing, -->
<!-- and mapping of coauthorship networks with Web of Science data. Journal of -->
<!-- Open Source Software 5(45): 2028, 10.21105/joss.02028 --> 
...
section of the manuscripts. We created codes for .xml and .pdf files [Link to processing code](R/01-processing_code.R), using the *xml2* (@Rxml2) and *tm*
...
related to "Methods", "Data" or "Statistical Analysis". 

[MEB: I feel like saying `tm` found all the various sections of the papers is burrying the lead. Y'all wrote all the code to actually extract that info, its giving tm way too much credit and us no credit. If you recheck the pdf-analysis code, theres a whole lot in there yall did. We just used tm::Corpus() to originally split stuff.]

Not all papers had an
