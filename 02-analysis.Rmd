...
Wordclouds of each topic based on most strongly associated abstracts. The code for this plot can be found [here](R/02-wordcloud_plot_II.R).
</center>
<br />
...
<center>
![](posts/moveco-images/Framework-StackPlot-2009-2018_full_MB.png){width=50%}

Stack plot of the percentage of studies published between 2009 and 2018 analyzing the components of the
movement ecology framework. Each row represents a combination of the colored
components, and the percentage of studies analyzing those components is
indicated for cases greater than 5%. For instance, the last row shows that 33.3% of the studies focused on the relation between external factors and movement, while the row above shows that 24.7% of the studies looked at both internal and external factors associated with movement. The code for the stack plot is [here](R/man_framework_stack_plot.R) (the graph was then edited in Inkscape for aesthetic purposes).
</center>
<br /> 

<center>
![](posts/moveco-images/Framework-StackPlot-1999-2008_full_MB.png){width=50%}

Stack plot of the percentage of studies published between 1999 and 2008 analyzing the components of the
movement ecology framework. Each row represents a combination of the colored
components, and the percentage of studies analyzing those components is
indicated for cases greater than 4%. The code for the stack plot is [here](R/man_framework_stack_plot_1999_2008.R) (the graph was then edited in Inkscape for aesthetic purposes).
</center>
<br /> 
